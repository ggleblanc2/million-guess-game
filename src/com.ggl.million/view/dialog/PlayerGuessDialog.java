...
public class PlayerGuessDialog extends JDialog {
	...
	public PlayerGuessDialog(MillionGuessesFrame view) {
		super(view.getFrame(), "Enter Number As Guess", true);
	...
	private JPanel createMainPanel() {
		...
		JLabel label = new JLabel("Type your 6 digit number guess:");
		panel.add(label);
	...
	private JPanel createButtonPanel() {
		...
		cancelButton.addActionListener(event -> {
			PlayerGuessDialog.this.dispose();
			returnCode = 8;
		});
